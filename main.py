...
def main() -> None:
    ...
    debate.add_argument("--mode", choices=["mock", "deepseek", "bailian"], default="mock")
    ...
    full.add_argument("--debate-mode", choices=["mock", "deepseek", "bailian"], default="mock")
    full.add_argument("--judge-mode", choices=["mock", "deepseek", "bailian"], default="mock")
    ...
    evaluate.add_argument("--debate-mode", choices=["mock", "deepseek", "bailian"], default="mock")
    evaluate.add_argument("--judge-mode", choices=["mock", "deepseek", "bailian"], default="mock")
    ...
    experiment.add_argument("--debate-mode", choices=["mock", "deepseek", "bailian"], default="mock")
    experiment.add_argument("--judge-mode", choices=["mock", "deepseek", "bailian"], default="mock")
    ...
    case_study.add_argument("--debate-mode", choices=["mock", "deepseek", "bailian"], default="deepseek")
    case_study.add_argument("--judge-mode", choices=["mock", "deepseek", "bailian"], default="mock")
