...
def main() -> None:
    ...
    parser.add_argument("--debate-mode", choices=["mock", "deepseek", "bailian"], default="deepseek")
    parser.add_argument("--judge-mode", choices=["mock", "deepseek", "bailian"], default="mock")
